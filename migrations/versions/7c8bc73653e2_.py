...
Revision ID: 7c8bc73653e2
Revises: 
Create Date: 2022-09-01 19:42:12.541158
...
def upgrade():
    ...
    sa.Column('from_room', sa.VARCHAR(), nullable=False),
    sa.Column('belongs_to', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['belongs_to'], ['user.id'], ),
    sa.ForeignKeyConstraint(['from_room'], ['room.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
